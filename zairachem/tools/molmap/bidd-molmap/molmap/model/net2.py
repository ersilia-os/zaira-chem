...
def MolMapNet(
    ...
    conv1 = Conv2D(48, conv1_kernel_size, padding="same", activation="relu", strides=1)(
        inputs
    )
...
def MolMapDualPathNet(
    ...
    d_conv1 = Conv2D(
        48, conv1_kernel_size, padding="same", activation="relu", strides=1
    )(d_inputs1)

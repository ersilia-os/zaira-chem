...
def GetPharmacoErGFPs(
    mol, fuzzIncrement=0.3, maxPath=21, binary=True, return_bitInfo=False
):
    """
    ...
    arr = AllChem.GetErGFingerprint(
        mol, fuzzIncrement=fuzzIncrement, maxPath=maxPath, minPath=minPath
    )

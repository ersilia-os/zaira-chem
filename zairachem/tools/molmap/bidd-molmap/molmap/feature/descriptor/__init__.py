...
class Extraction:
    def __init__(self, feature_dict={}):
        ...
        if feature_dict == {}:
            ...
            factory = {
                key: mapkey[key] for key in set(feature_dict.keys()) & set(mapkey)
            }
    ...
    def batch_transform(self, smiles_list, n_jobs=4):
        ...
        res = P(
            delayed(self.transform)(smiles) for smiles in tqdm(smiles_list, ascii=True)
        )
        return np.stack(res)
